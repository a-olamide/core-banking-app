...
{
    public sealed class LienConfiguration : IEntityTypeConfiguration<Lien>
    {
        public void Configure(EntityTypeBuilder<Lien> builder)
        {
            builder.ToTable("AccountLiens");
            ...
            builder.HasIndex("AccountId").HasDatabaseName("IX_AccountLiens_AccountId");
            builder.HasIndex(x => x.Status).HasDatabaseName("IX_AccountLiens_Status");
        }
    }
}
